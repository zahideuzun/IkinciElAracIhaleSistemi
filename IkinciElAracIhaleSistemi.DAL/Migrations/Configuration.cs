    ...
    internal sealed class Configuration : DbMigrationsConfiguration<IkinciElAracIhaleSistemi.DAL.Context.AracIhaleContext>
    {
        ...
        protected override void Seed(IkinciElAracIhaleSistemi.DAL.Context.AracIhaleContext context)
        {
			...
			context.Araclar.AddOrUpdate(
				new Arac { Id = 1, Plaka = "06 ZIU 1998", MarkaId = 1, ModelId = 1, Km = 100000, Yil = 2015, KullaniciId = 1, UyeId = 2, BireyselMi = false},
				new Arac { Id = 2, Plaka = "06 ZU 1998", UyeId = 1, BireyselMi = true, MarkaId = 2, ModelId = 3, Km = 150000, Yil = 2017, KullaniciId = 1 },
				new Arac { Id = 3, Plaka = "06 IU 1998", UyeId = 1, BireyselMi = true, MarkaId = 3, ModelId = 4, Km = 116542, Yil = 2020, KullaniciId = 1 },
				new Arac { Id = 4, Plaka = "06 DU 1998", UyeId = 1, BireyselMi = true, MarkaId = 3, ModelId = 4, Km = 200000, Yil = 2014, KullaniciId = 1 },
				new Arac { Id = 5, Plaka = "06 MU 1998", UyeId = 1, BireyselMi = true, MarkaId = 4, ModelId = 5, Km = 300000, Yil = 2005, KullaniciId = 1 },
				new Arac { Id = 6, Plaka = "06 AU 1998", UyeId = 2, BireyselMi = false, MarkaId = 5, ModelId = 12, Km = 60000, Yil = 2021, KullaniciId = 1 },
				new Arac { Id = 7, Plaka = "06 RU 1998", UyeId = 2, BireyselMi = false, MarkaId = 5, ModelId = 13, Km = 90000, Yil = 2021, KullaniciId = 1 },
				new Arac { Id = 8, Plaka = "06 NU 1998", UyeId = 2, BireyselMi = false, MarkaId = 6, ModelId = 14, Km = 220000, Yil = 2015, KullaniciId = 1 },
				new Arac { Id = 9, Plaka = "06 BU 1998", UyeId = 2, BireyselMi = false, MarkaId = 7, ModelId = 8, Km = 240050, Yil = 2015, KullaniciId = 1 },
				new Arac { Id = 10, Plaka = "06 RU 1998", UyeId = 1, BireyselMi = true, MarkaId = 7, ModelId = 9, Km = 140000, Yil = 2019, KullaniciId = 1 },
				new Arac { Id = 11, Plaka = "06 GU 1998", UyeId = 1, BireyselMi = true, MarkaId = 8, ModelId = 6, Km = 280000, Yil = 2012, KullaniciId = 1 },
				new Arac { Id = 12, Plaka = "06 SU 1998", UyeId = 1, BireyselMi = true, MarkaId = 8, ModelId = 7, Km = 195000, Yil = 2017, KullaniciId = 1 },
				new Arac { Id = 13, Plaka = "06 GS 1998", UyeId = 1, BireyselMi = true, MarkaId = 9, ModelId = 10, Km = 32000, Yil = 2022, KullaniciId = 1 },
				new Arac { Id = 14, Plaka = "06 BJK 199", UyeId = 1, BireyselMi = true, MarkaId = 10, ModelId = 11, Km = 100000, Yil = 2015, KullaniciId = 1 }
			...
			context.AracOzellikleri.AddOrUpdate(
				...
				new AracOzellik { Id = 10, AracId = 4, OzellikDetayId = 19 },
				...
				new AracOzellik { Id = 25, AracId = 9, OzellikDetayId = 20 },
				...
				new AracOzellik { Id = 30, AracId = 10, OzellikDetayId = 19 },
				new AracOzellik { Id = 30, AracId = 11, OzellikDetayId = 19 },
				new AracOzellik { Id = 30, AracId = 12, OzellikDetayId = 19 },
				new AracOzellik { Id = 30, AracId = 13, OzellikDetayId = 19 },
				new AracOzellik { Id = 30, AracId = 14, OzellikDetayId = 19 }
